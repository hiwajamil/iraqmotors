...
const List<LocalizedCarModel> ChanganModels = [
  ...
  LocalizedCarModel(id: 'changan_cs35_plus', ku: 'CS35پلەس', en: 'CS35 Plus', ar: 'CS35 بلس'),
  LocalizedCarModel(id: 'changan_cs55', ku: 'CS55', en: 'CS55', ar: 'CS55'),
  LocalizedCarModel(id: 'cs75', ku: 'CS75', en: 'CS75', ar: 'CS75'),
  LocalizedCarModel(id: 'changan_cs75_plus', ku: 'CS75 پڵەس', en: 'CS75 Plus', ar: 'CS75 بلس'),
  ...
  LocalizedCarModel(id: 'changan_eado_plus', ku: 'ئیدۆ پڵەس', en: 'Eado Plus', ar: 'إيدو بلس'),
  ...
  LocalizedCarModel(id: 'changan_star_truck', ku: 'ستار تراک', en: 'Star Truck', ar: 'ستار تراك'),
  ...
  LocalizedCarModel(id: 'changan_x5_plus', ku: 'X5 پڵەس', en: 'X5 Plus', ar: 'X5 بلس'),
];
